...
public class DBManager extends SQLiteOpenHelper{
    ...
    public int getTaskCompleted(){
        int count = 0;
        SQLiteDatabase db = getReadableDatabase();
        String query = "SELECT * FROM " + TABLE_TASKS + " WHERE "+TASKS_COMPLETION+" = 1 AND "+TASKS_DATE+" = \""+getCurrentDate()+"\";";
    ...
    public ArrayList<Reminders> getCurrentReminders(){
            ...
            String query = "SELECT * FROM " + TABLE_REMINDERS + " WHERE "+REMIND_DATE+" = \""+getCurrentDate()+"\";";
